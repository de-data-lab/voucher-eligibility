...
ggplot_cases_time_cont = data %>% group_by(county,perc_hh_income_rent) %>% 
  ...
  xlab("County")+
  labs(color = "Percentage of hh_income spent on rent")+
  ggtitle("Number of Eligible household by percentage category")
...
ggplot_cases_time_cont = data %>% group_by(county) %>% 
  ...
  ylab("Total Eligible")+
  xlab("County")+
  labs(color = "Percentage of household not receiving rental assistance by housing vouchers")+
  ggtitle("Percentage of household not receiving rental assistance by housing vouchers")
...
ggplot_cases_time_cont = data %>%
  ...
  geom_point()+
  theme_minimal()+
  xlab("Percentage of household not receiving housing vouchers")+
  ylab('Median Rent')+
  labs(color = "County")+
